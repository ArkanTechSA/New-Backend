            ...
            <div class="card">
                <div class="card-header border-bottom">
                    ...
                    <div class="mb-3 d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">@lang('dashboard.service_requesters')</h5>


                        <button type="button" class="btn btn-primary" id="addProviderBtn">
                            @lang('dashboard.add_requesters_provider')
                        </button>
                    </div>
        ...
        @push('Dashboard-scripts')
            ...
            <script>
                function fetchUsers() {
                    ...
                    fetch(`{{ route('admin.requesters.search') }}?${params.toString()}`)
            ...
            <script>
                document.getElementById("addProviderBtn").addEventListener("click", function() {
                    window.location.href = "{{ route('requesters.create') }}";
                });
            </script>
        @endpush
</x-layout.default>
